class Parameter {
    ...
    constructor(id: string, description: string, sign: boolean, min: number, max: number, step: number, unit: string) {
        this.id = id;
...
class TableGenerator {
    ...
    generate(parent: HTMLElement) {
        let table: HTMLTableElement = document.createElement("table");
        let headerRow: HTMLTableRowElement = document.createElement("tr");

        let idHeaderCell: HTMLTableHeaderCellElement = document.createElement("th");
        idHeaderCell.innerText = "Параметр";

        let descriptionHeaderCell: HTMLTableHeaderCellElement = document.createElement("th");
        descriptionHeaderCell.innerText = "Описание параметра и единица его измерения";

        let valueHeaderCell: HTMLTableHeaderCellElement = document.createElement("th");
        valueHeaderCell.innerText = "Действующее значение параметра";

        let lastEditDateHeaderCell: HTMLTableHeaderCellElement = document.createElement("th");
        lastEditDateHeaderCell.innerText = "Дата последнего изменения параметра";

        let lastEditTimeHeaderCell: HTMLTableHeaderCellElement = document.createElement("th");
        lastEditTimeHeaderCell.innerText = "Время последнего изменения параметра";

        let newValueHeaderCell: HTMLTableHeaderCellElement = document.createElement("th");
        newValueHeaderCell.innerText = "Новое значение параметра";

        let valueRangeHeaderCell: HTMLTableHeaderCellElement = document.createElement("th");
        valueRangeHeaderCell.innerText = "Диапазон ввода";

        let emptyHeaderCell: HTMLTableHeaderCellElement = document.createElement("th");
        ...
        for (let i: number = 0; i < this.parameters.length; ++i) {
            ...
            let descriptionCell: HTMLTableCellElement = document.createElement("td");
            descriptionCell.innerText = this.parameters[i].description;

            let valueCell: HTMLTableCellElement = document.createElement("td");
            valueCell.innerText = "-";

            let lastEditDateCell: HTMLTableCellElement = document.createElement("td");
            lastEditDateCell.innerText = "-";

            let lastEditTimeCell: HTMLTableCellElement = document.createElement("td");
            lastEditTimeCell.innerText = "-";

            let newValueCell: HTMLTableCellElement = document.createElement("td");
            newValueCell.innerText = "-";

            let valueRangeCell: HTMLTableCellElement = document.createElement("td");
            ...
            let editButtonImage: HTMLImageElement = new Image();
