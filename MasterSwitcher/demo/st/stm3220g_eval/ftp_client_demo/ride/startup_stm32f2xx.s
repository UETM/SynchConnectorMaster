 ...
 * @author    Raisonance - mix from stm32f10x startup for gcc and stm32f2x startup for ARM
 *            to be reviewed by ST - MCD Application Team and integrated in official lib
 * @version   V0.0.4
 * @date      01/26/2011
 * @brief     STM32F2xx devices vector table for GCC toolchain.
 *               This module performs:
 *               - Set the default initial SP
 *               - Configure external SRAM if needed
 *               - Set the user initial SP
 *               - Initialize memory (global variables...)
 ...
 * TIME. AS A RESULT, STMICROELECTRONICS AND RAISONANCE SHALL NOT BE HELD LIABLE
 ...
 *         unexpected interrupt or returns from main().
...
/**
 * @brief  Dummy SystemInit function 
 * @param  None     
 * @retval : None       
*/
	.section	.text.SystemInit_Dummy,"ax",%progbits
SystemInit_Dummy:
	bx	lr
	.size	SystemInit_Dummy, .-SystemInit_Dummy



.weak	SystemInit_ExtMemCtl
        .thumb_set SystemInit_ExtMemCtl,SystemInit_Dummy

.weak	SystemInit
        .thumb_set SystemInit,SystemInit_Dummy
