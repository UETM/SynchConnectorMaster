...
struct _TftpClientConnection
{
   ...
   char_t packet[TFTP_SERVER_MAX_PACKET_SIZE]; ///<Outgoing TFTP packet
...
struct _TftpServerContext
{
   ...
   char_t packet[TFTP_SERVER_MAX_PACKET_SIZE];                   ///<Incoming TFTP packet
};
...
void tftpProcessPacket(TftpServerContext *context, TftpClientConnection *connection);
