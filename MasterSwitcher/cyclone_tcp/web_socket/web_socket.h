...
//Size of the WebSocket buffer
   ...
   #define WEB_SOCKET_BUFFER_SIZE 512
...
typedef enum
{
   ...
   WS_STATE_TLS_HANDSHAKE      = 4,
   WS_STATE_CLIENT_HANDSHAKE   = 5,
   WS_STATE_SERVER_HANDSHAKE   = 6,
   WS_STATE_SERVER_RESP_BODY   = 7,
   WS_STATE_OPEN               = 8,
   WS_STATE_CLOSING_TX         = 9,
   WS_STATE_CLOSING_RX         = 10,
   WS_STATE_TLS_SHUTDOWN       = 11,
   WS_STATE_SOCKET_SHUTDOWN_TX = 12,
   WS_STATE_SOCKET_SHUTDOWN_RX = 13
} WebSocketState;
