...
#define SMTP_DEFAULT_TIMEOUT SMTP_CLIENT_DEFAULT_TIMEOUT
#define SMTP_MAX_LINE_LENGTH SMTP_CLIENT_MAX_LINE_LENGTH
#define SMTP_TLS_SUPPORT SMTP_CLIENT_TLS_SUPPORT
#define SMTP_LOGIN_AUTH_SUPPORT SMTP_CLIENT_LOGIN_AUTH_SUPPORT
#define SMTP_PLAIN_AUTH_SUPPORT SMTP_CLIENT_PLAIN_AUTH_SUPPORT
#define SMTP_CRAM_MD5_AUTH_SUPPORT SMTP_CLIENT_CRAM_MD5_AUTH_SUPPORT
